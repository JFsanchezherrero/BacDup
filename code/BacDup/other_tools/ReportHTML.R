...
## Load packages
#### --------------------------------------- ####
source("ReportPlots.R")
source("ReportConf/utilities.R")
source("ReportConf/report_class.R")
source("ReportConf/Report_methods.R")
# if error: no existing definition for function ‘off’, please, clear workspace, restart R session and run again
source("ReportConf/ReportPlot_class.R")
source("ReportConf/ReportPlot_methods.R")
