...
seq_lengths <- read.csv(file.path(data_folder, "./data/length_df.csv"), header=FALSE, row.names=1)
dup_info_file <- read.csv(file.path(data_folder, "./data/dup_annot.csv"), header=TRUE, row.names = 1)
